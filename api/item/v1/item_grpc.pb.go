...
const (
	ItemService_GetItem_FullMethodName    = "/api.item.v1.ItemService/GetItem"
	ItemService_CreateItem_FullMethodName = "/api.item.v1.ItemService/CreateItem"
	ItemService_UpdateItem_FullMethodName = "/api.item.v1.ItemService/UpdateItem"
	ItemService_DeleteItem_FullMethodName = "/api.item.v1.ItemService/DeleteItem"
	ItemService_ListItems_FullMethodName  = "/api.item.v1.ItemService/ListItems"
)
...
var ItemService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/item/v1/item.proto",
}
